...
public interface BookRepository extends JpaRepository<Book, Long>, JpaSpecificationExecutor<Book> {
    ...
    Optional<Book> findBooksByPublishYear(@Param("publishYear") LocalDate publishYear);

    Optional<Book> findBooksByPublishDate(@Param("publishDate") LocalDate publishDate);
